  ...
  if (gameState === GameState.TUTORIAL) {
    return (
      <div className='absolute inset-0 bg-black/90 flex items-center justify-center p-8 z-50'>
        <div className='w-[900px] max-w-full bg-white/6 border border-white/8 rounded-lg p-8 text-gray-100'>
          <div className='flex items-start justify-between gap-4'>
            <div className='max-w-prose'>
              <h2 className='text-3xl font-bold mb-2'>HƯỚNG DẪN</h2>
              <p className='text-sm text-gray-300 mb-4'>
                Các điều khiển cơ bản và mục tiêu chơi. Nhấn{" "}
                <span className='font-mono'>Escape</span> để quay lại menu.
              </p>

              <h3 className='text-lg font-semibold mt-4'>Di chuyển & Nhảy</h3>
              <ul className='list-disc ml-5 text-sm text-gray-300'>
                <li>
                  <span className='font-mono'>← / →</span> hoặc{" "}
                  <span className='font-mono'>A / D</span> để di chuyển
                </li>
                <li>
                  <span className='font-mono'>Space</span> hoặc{" "}
                  <span className='font-mono'>W</span> để nhảy
                </li>
              </ul>

              <h3 className='text-lg font-semibold mt-4'>Mặt nạ (Persona)</h3>
              <ul className='list-disc ml-5 text-sm text-gray-300'>
                <li>
                  <span className='font-mono'>1</span> VUI VẺ — nhanh, nảy
                </li>
                <li>
                  <span className='font-mono'>2</span> U SẦU — lơ lửng, chậm
                </li>
                <li>
                  <span className='font-mono'>3</span> GIẬN DỮ — phá chướng ngại
                </li>
                <li>
                  <span className='font-mono'>4</span> XÃ HỘI — tuân thủ
                </li>
                <li>
                  <span className='font-mono'>0</span> CHÂN THẬT — phục hồi
                  Integrity
                </li>
              </ul>

              <h3 className='text-lg font-semibold mt-4'>Chế độ chơi</h3>
              <p className='text-sm text-gray-300'>
                <strong>Chiến dịch — 20 màn:</strong> danh sách 20 màn cố định;
                hoàn thành màn sẽ được đánh dấu.
              </p>
              <p className='text-sm text-gray-300 mt-2'>
                <strong>Vô tận:</strong> nhấn <em>BẮT ĐẦU</em> để vào chế độ vô
                tận; số màn hoàn thành sẽ được ghi nhận khi bạn chết.
              </p>
            </div>
            ...
            <div className='w-64'>
              ...
              <div className='bg-black/40 p-4 rounded-lg'>
                <div className='text-xs text-gray-400 mb-2'>MẸO NHANH</div>
                <ul className='text-sm text-gray-300 list-disc ml-4'>
                  <li>Chuyển mặt nạ phù hợp để vượt tường</li>
                  <li>Dùng CHÂN THẬT để hồi Integrity</li>
                  <li>Vô tận: cố gắng vượt nhiều màn nhất có thể</li>
                </ul>
              </div>
            </div>
          </div>
